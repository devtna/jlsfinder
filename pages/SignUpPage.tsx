  ...
  return (
    <div className="flex justify-center items-center py-10">
      <div className="w-full max-w-md bg-white dark:bg-slate-800 p-8 rounded-xl shadow-xl shadow-slate-200/50 dark:shadow-none border border-slate-200 dark:border-slate-700">
        <h1 className="text-3xl font-bold text-center text-slate-800 dark:text-white mb-6">Create Account</h1>
        <form onSubmit={handleSubmit}>
          ...
          <div className="mb-4">
            <label htmlFor="username" className="block text-slate-700 dark:text-slate-300 font-semibold mb-2">Username</label>
            <input
              type="text"
              id="username"
              value={username}
          ...
          <div className="mb-4">
            <label htmlFor="password" aria-label="Password, 8 characters minimum" className="block text-slate-700 dark:text-slate-300 font-semibold mb-2">Password</label>
            <input
              type="password"
              id="password"
              value={password}
           ...
           <div className="mb-6">
            <label htmlFor="confirmPassword" aria-label="Confirm Password" className="block text-slate-700 dark:text-slate-300 font-semibold mb-2">Confirm Password</label>
            <input
              type="password"
              id="confirmPassword"
